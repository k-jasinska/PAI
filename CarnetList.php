...
<div class="wrapper1 active"> 
    ...
    <aside class="active">
			...
			<div class="menu__wrap">
				...
				<li class="menu__item"><a class="menu__link" id="menu_click" data-submenu="submenu-2" href="CarnetList.php"><i class="fas fa-list-ul"></i>Lista karnetów</a></li>
...
<table id="table" class="table table-striped table-bordered nowrap" style="width:100%; background-color:white;">
      ...
      echo "<td><input type='button' name='log' id='$tabl[id_person]' value=' Wszedł ' class='btn btn-info btn-xs view_data'/> </td></tr>";
      }
      else{
