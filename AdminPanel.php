...
<div class="wrapper1 active"> 
    ...
    <aside class="active">
          ...
          <li class="menu__item"><a class="menu__link" id="menu_click" data-submenu="submenu-1" href="AdminPanel.php"><i class="fas fa-users"></i>Lista klientów</a></li>
					...
					<li class="menu__item"><a class="menu__link" data-submenu="submenu-3" href="Statistics.php"><i class="fas fa-chart-line"></i>Statystyki </a></li>
...
<table id="table" class="table table-striped table-bordered nowrap" style="width:100%; background-color:white;">
 ...
 <td><input type='button' name='$tabl[id_person]' value='Pokaż' id='$tabl[id_adres]' class='btn btn-info btn-xs view_data'/></td>
       </tr>";
      }
      ?>
      </tbody>
